...
import features8 from '@/public/images/featuresbg/features8.svg';
    ...
    <div className="min-h-screen">
      <div className="">
        ...
        <PageBorders overflow={null}>
          ...
          >
            <div className="z-10 flex flex-col items-start justify-start gap-8 self-start md:sticky md:top-0">
              {' '}
          ...
          >
            ...
            <div className="">
              ...
              <div className="flex flex-col items-start gap-4 md:gap-8">
                ...
                <SlideDown delay={0.2} duration={1.5}>
                  <Link href={'/contact-us'}>
                    <MainButton text={'Book consultation'} />
                  </Link>
                </SlideDown>
            ...
            <div className="hidden h-full md:block">
              {' '}
              <SlideLeft>
                <div className="h-full bg-features9 bg-contain bg-left bg-no-repeat"></div>
              </SlideLeft>{' '}
            </div>
          </div>
        </DoublePageBorders>
