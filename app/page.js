      ...
      <div className="">
              ...
              <div className="flex flex-col gap-8">
                ...
                <div className="flex flex-wrap items-center justify-start gap-2 lg:gap-4">
                  {singleServive.map((item, index) => (
                    <p
                      key={index}
                      className="font-Gilroy rounded-[50px] bg-[#c9ceea] px-2 py-2 text-[10px] font-extralight tracking-normal text-mainBlack md:px-6 md:py-3 md:text-[14px] lg:text-[16px]"
                    >
                      {item}
                    </p>
                  ))}
        ...
        <PageBorders padding={null}>
          <div className="relative bg-darkestBlue" id="industry">
            {' '}
            <div className="absolute left-0 top-0 z-0 h-[30vh] w-full bg-mainWhite lg:h-[25vh] xl:h-[40vh]"></div>
            <PageBorders background={'relative'}>
              <div className="flex flex-col gap-4 md:gap-8">
                ...
                <div className="relative z-10 grid gap-4 md:grid-cols-2 md:gap-8">
                ...
                <SlideRight>
                  <div className="flex gap-4 md:gap-8">
                    {getHelp.map((item, index) => (
                      <div
                        key={index}
                        className={`${item.background} group max-h-[60vh] min-h-[40vh] flex-[1] overflow-hidden rounded-[10px] bg-cover bg-center bg-no-repeat transition-all duration-500 ease-out hover:flex-[12] lg:hover:flex-[6] xl:hover:flex-[2]`}
                      >
                        {/* Background overlay + content wrapper */}
                        <div className="flex h-full flex-col justify-end group-hover:bg-primaryGradient">
                          <div className="flex flex-col justify-end gap-4 p-[20px] text-mainWhite opacity-0 transition-opacity duration-500 group-hover:opacity-100 md:h-1/2 md:p-[30px]">
                            <h1 className="font-lato text-[16px] font-semibold leading-tight lg:text-[20px]">
                              {item.title}
                            </h1>
                            <p className="font-lato text-[14px] font-normal">
                              {item.subtitle}
                            </p>
                            <Link href={'/contact-us'}>
                              {' '}
                              <button className="font-lato font-semibold text-darkBlue hover:underline">
                                Learn More
                              </button>
                            </Link>
                          </div>
